...
<header class="bg-white px-2 sm:px-4 py-2.5 fixed w-full z-50 top-0 left-0 border-b shadow-lg border-gray-200 mb-24">
  <div class="navbar-body">
    ...
    <div class="navbar-button">
      <button type="button" class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0">Get Started</button>
